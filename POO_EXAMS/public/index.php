 ...
 * --   lister=> cours
 *   -- supprimer => cours-del
 * une Implementation c'est lorsqu'une methode abstraite est traduite en une methode concrete
 * une methode d'instance est une methode qui depend de la valeur de l'objet
 */
...
//Front controller fichier par lequel passe toutes les requetes GET ou POST
