...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=1892005172ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Tables récentes" class="drop_button btn">Récentes</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=gestion_scolaire_l2&table=classe">`gestion_scolaire_l2`.`classe`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=gestion_scolaire_l2&table=etudiant">`gestion_scolaire_l2`.`etudiant`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=gestion_scolaire_l2&table=dossier_etudiant">`gestion_scolaire_l2`.`dossier_etudiant`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=gestion_scolaire_l2&table=Dossier_etudiant">`gestion_scolaire_l2`.`Dossier_etudiant`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=gestion_scolaire_l2&table=inscription">`gestion_scolaire_l2`.`inscription`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=gestion_scolaire_l2&table=user">`gestion_scolaire_l2`.`user`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=gestion_scolaire_l2&table=cours">`gestion_scolaire_l2`.`cours`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=gestion_scolaire_l2&table=professeur_module">`gestion_scolaire_l2`.`professeur_module`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=gestion_scolaire_l2&table=module">`gestion_scolaire_l2`.`module`</a></li></ul></div><div class="drop_list"><button title="Tables préférées" class="drop_button btn">Préférées</button><ul id="pma_favorite_list"><li class="warp_link">Pas de tables préférées.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="784474732b5856663074287e73672e4a">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Faire Entrée pour exécuter la requête                    </span>
                            ...
                            targetdb="gestion_scolaire_l2" targettable="user">
            ...
            Daté du
                            ...
                            targetdb="gestion_scolaire_l2" targettable="etudiant">
                            <div class="action_content">
                    <span class="action collapse">
            Réduire
                    </span>
            ...
            Daté du
                            ...
                            <span class="query">CREATE TABLE `gestion_scolaire_l2`.`etudiant` ( `dossier_etudiant_id` INT NOT NULL ,    INDEX  (`dossier_etudiant_id`)) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="gestion_scolaire_l2" targettable="inscription">
                            <div class="action_content">
                    <span class="action collapse">
            Réduire
                    </span>
            ...
            Daté du
                            ...
                            <span class="query">CREATE TABLE `gestion_scolaire_l2`.`inscription` ( `id` INT NOT NULL AUTO_INCREMENT ,  `date_inscription` DATE NOT NULL ,  `etudiant_id` INT NOT NULL ,    PRIMARY KEY  (`id`),    INDEX  (`etudiant_id`)) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="gestion_scolaire_l2" targettable="inscription">
                            <div class="action_content">
            ...
            Daté du
                            ...
                            <span class="query">SELECT * FROM `inscription`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="gestion_scolaire_l2" targettable="etudiant">
                            <div class="action_content">
            ...
            Daté du
                            ...
                            <span class="query">SELECT * FROM `etudiant`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="gestion_scolaire_l2" targettable="inscription">
                            <div class="action_content">
            ...
            Daté du
                            ...
                            <span class="query">SELECT * FROM `etudiant`</span>
                                            ...
                                            <div class="message history collapsed hide"
                            targetdb="gestion_scolaire_l2" targettable="dossier_etudiant">
                            <div class="action_content">
                    <span class="action collapse">
            Réduire
                    </span>
            ...
            Daté du
                            ...
                            <span class="query">CREATE TABLE `gestion_scolaire_l2`.`dossier_etudiant` ( `id` INT NOT NULL AUTO_INCREMENT ,    PRIMARY KEY  (`id`)) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="gestion_scolaire_l2" targettable="dossier_etudiant">
                            <div class="action_content">
            ...
            Daté du
                            ...
                            <span class="query">CREATE TABLE `gestion_scolaire_l2`.`dossier_etudiant` ( `id` INT NOT NULL AUTO_INCREMENT ,  `date_ouverture` DATE NOT NULL ,    PRIMARY KEY  (`id`)) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="gestion_scolaire_l2" targettable="etudiant">
                            <div class="action_content">
            ...
            Daté du
                            ...
                            <span class="query">SELECT * FROM `etudiant`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="gestion_scolaire_l2" targettable="classe">
                            <div class="action_content">
                    <span class="action collapse">
            Réduire
                    </span>
